    ...
    <section className="min-h-screen flex items-center relative overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-24 relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          <p className="text-turquoise font-space tracking-wider mb-4">WE CREATE DIGITAL EXPERIENCES</p>
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6">
            ...
            <br />
            <span className="text-glow text-turquoise">Digital Reality</span>
          </h1>
          
          <p className="text-lg md:text-xl text-foreground/70 mb-8 max-w-2xl">
            We design and develop cutting-edge web experiences that captivate audiences and drive conversions for forward-thinking brands.
          </p>
